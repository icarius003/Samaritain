<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td style="padding: 0 0 24px 0;">
            <p style="margin: 0; font-size: 15px; color: #374151; line-height: 1.6;">
                {{ __("Nous avons reçu une demande de réinitialisation de votre mot de passe.") }}
            </p>
        </td>
    </tr>
    <tr>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td align="center" style="border-radius: 8px;" bgcolor="#b8860b">
                        <a href="{{ $resetUrl ?? '#' }}" target="_blank" class="email-button" style="display: inline-block; padding: 14px 32px; font-size: 15px; font-weight: 600; line-height: 1.4; text-decoration: none; border-radius: 8px; color: #ffffff !important; background-color: #b8860b;">
    ...
    <tr>
        <td style="padding: 0 0 8px 0;">
            <p style="margin: 0; font-size: 13px; color: #6b7280; line-height: 1.5;">
                {{ __("Ce lien de réinitialisation expirera dans :count minutes.", ['count' => config('auth.passwords.users.expire', 60)]) }}
            </p>
        </td>
    </tr>
    <tr>
        <td style="padding: 0 0 8px 0; border-top: 1px solid #e5e7eb;">
            ...
            <p style="margin: 4px 0 0 0; font-size: 13px; color: #b8860b; word-break: break-all; line-height: 1.5;">
                <a href="{{ $resetUrl ?? '#' }}" style="color: #b8860b; text-decoration: underline;">{{ $resetUrl ?? '#' }}</a>
            </p>
        </td>
    </tr>
    <tr>
        <td style="padding: 16px 0 0 0;">
            <p style="margin: 0; font-size: 13px; color: #6b7280; line-height: 1.5; font-style: italic;">
                {{ __("Si vous n'êtes pas à l'origine de cette demande, vous pouvez ignorer cet email. Votre mot de passe restera inchangé.") }}
            </p>
        </td>
    </tr>
</table>